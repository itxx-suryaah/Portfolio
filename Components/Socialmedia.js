    ...
    <StyledWrapper>
      <div className="social-login-icons">
        <div className="socialcontainer">
          <a href="https://x.com/itxx_Suryaah" target="_blank" rel="noopener noreferrer">
        ...
        <div className="socialcontainer">
          <a href="https://www.instagram.com/itxx_suryaah?igsh=ZXc1azh2MXk5bmtq" target="_blank" rel="noopener noreferrer">
        ...
        <div className="socialcontainer">
          <a href="http://www.facebook.com/itxx.surya" target="_blank" rel="noopener noreferrer">
        ...
        <div className="socialcontainer">
          <div className="icon social-icon-4-4">
            <a href="https://github.com/itxx-suryaah" target="_blank" rel="noopener noreferrer">
